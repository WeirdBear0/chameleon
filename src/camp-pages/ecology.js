...
function Ecology() {
  return (
    <div className='campInfo'>
        <p className='specs'> July 15-19 | 10-1 PM | $150 | Grades 6-8</p>
        <p className='title'>Ecology</p>
        <div className='info-container'>
          <div className='info-width'>
            <p className='info'>
              Our Ecology and Technology camp focuses on the exploration of advanced farming through small-scale class farms integrated 
